...
public class Client {
	...
	public static void main(String[] args) throws Exception {
		...
		//String file="resources/spring.xml";  //For individual bean init and destroy
		String file="resources/spring-default-init-destroy.xml"; //for all beans init and destroy
